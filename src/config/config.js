module.exports = {
	...
	CONFIG:{
		...
		spAttackList: [`压制`,`破盾`,`气溃`,`精溃`,`锁敌`,`攻心`,`淘金`,],
		...
		spLevelMap: [ // sp威力等级表 TODO
			[1000,1500,2000,2500,3000,3500,4000,4500,5000,], // 1压制
			[1000,1500,2000,2500,3000,3500,4000,4500,5000,], // 2破盾
			[1000,1500,2000,2500,3000,3500,4000,4500,5000,], // 3气溃
			[1000,1500,2000,2500,3000,3500,4000,4500,5000,], // 4精溃
			[1000,1500,2000,2500,3000,3500,4000,4500,5000,], // 5锁敌
			[1000,1500,2000,2500,3000,3500,4000,4500,5000,], // 6攻心
			[1000,1500,2000,2500,3000,3500,4000,4500,5000,], // 7摸金
		],
...
role = {
	...
	changes:{
		...
		// 101浮动数字（血|精力|心防|钱） 102行动力 103潜能 104存在感 105破盾 106miss
