module.exports = {
	...
	CONFIG:{
		...
		mapConfig: [
			...
			{id:102, level:1, type:2, name:'活死人墓穴',floors:[`流民`,`盗墓贼`,], },
			{id:103, level:2, type:2, name:'禁行山',    floors:[`混混`,`悍匪`,`悍匪头目`,], },
			{id:104, level:3, type:2, name:'熔碎洞窟',  floors:[`学徒`,`匠人`,`铸剑宗师`,], },
			{id:105, level:4, type:2, name:'冻海',      floors:[`水手`,`海盗`,`舰长`,], },
			{id:106, level:5, type:2, name:'落叶城',    floors:[`猎人`,`剑士`,`参谋`,`领袖`,], },
			{id:107, level:6, type:2, name:'愚困密道',  floors:[`密探`,`信徒`,`邪术师`,`主教`,], },
			{id:108, level:7, type:2, name:'云谷',      floors:[`鸟人`,`求道者`,`天使`,], },
			{id:109, level:8, type:2, name:'终神宫',    floors:[`士族`,`卫兵`,`骑士`,`副统帅`,`统帅`,], },
			{id:110, level:9, type:2, name:'漩涡',      floors:[`天选`,`神话`,], },
		],
