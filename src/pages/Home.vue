<template>
    <div class="main" v-if="game.campList">
        ...
        <div class="tab-wrap">
            ...
            <a class="btn btn-tab" :class="{'active':state==2}" @click="onTapTab(2)">领地</a>
        ...
        <div class="footer">
            <div class="fact">
                <div class="fact-item">总金币：{{numFormat(game.campList[0].money)}} $</div>
...
<style scoped>
    ...
    .map .maprow .btn-mapcell:not(:last-child){
        margin-right: .78rem;
    }
    .map .maprow .btn-mapcell .mapcell-dot{
        position: absolute;
        display: flex;
        justify-content: center;
        align-items: center;
        ...
        color: #fff;
        font-weight: bold;
        transform: scaleX(1.6666);
    }
    .map .maprow .btn-mapcell::before{
        content: '';
        display: block;
        position: absolute;
        top: 0;
